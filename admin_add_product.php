...
<div class="container">
    ...
    <form action="admin_process_product.php" method="POST" enctype="multipart/form-data">
		...
		<label>Price</label>
        <input type="number" name="price" min="10" step="0.01" value="10" required >
       ...
       <label>Sub Category</label>
        <select name="subcategory" required>
			...
			<option value="dogcare">Dog Care</option>
			<option value="birdbird">Bird Care</option>
        </select>
		...
		<img id="preview" src="" alt="Image Preview" style="display:none; max-width:200px; margin-top:10px; border:1px solid #ccc; padding:5px; border-radius:5px;">
